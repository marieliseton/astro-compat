...
// v4 : 4 textes par facette + synthèse globale, calibrés sur les sous-scores
// (honnêteté liée au score). Le suffixe invalide les contenus v3 en cache.
const PREFIX = 'astro_compat_v4_';
